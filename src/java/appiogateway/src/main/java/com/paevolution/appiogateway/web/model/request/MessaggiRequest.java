...
import com.paevolution.appiogateway.annotations.UTCISODateFromStringConstraint;
...
public class MessaggiRequest {
    ...
    @UTCISODateFromStringConstraint(message = "il campo due_date deve essere nel formato 2018-10-13T00:00:00.000Z")
    ...
    @NotNull(message = "il campo message_id è obbligatorio")
