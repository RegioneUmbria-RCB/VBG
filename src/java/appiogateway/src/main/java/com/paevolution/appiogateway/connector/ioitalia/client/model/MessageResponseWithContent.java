...
public class MessageResponseWithContent {

    @JsonProperty("message")
    private CreatedMessageWithContent message;
    @JsonProperty("notification")
    private MessageResponseNotificationStatus notification;
    @JsonProperty("status")
    private String status;

    public MessageResponseWithContent message(CreatedMessageWithContent message) {
    ...
    @NotNull
    @Valid
    public CreatedMessageWithContent getMessage() {

	return message;
    }

    public void setMessage(CreatedMessageWithContent message) {

	this.message = message;
    }

    public MessageResponseWithContent notification(MessageResponseNotificationStatus notification) {
    ...
    public MessageResponseWithContent status(String status) {
	...
	MessageResponseWithContent messageResponseWithContent = (MessageResponseWithContent) o;
	return Objects.equals(this.message, messageResponseWithContent.message)
		&& Objects.equals(this.notification, messageResponseWithContent.notification)
		&& Objects.equals(this.status, messageResponseWithContent.status);
    }
	...
	sb.append("class MessageResponseWithContent {\n");
