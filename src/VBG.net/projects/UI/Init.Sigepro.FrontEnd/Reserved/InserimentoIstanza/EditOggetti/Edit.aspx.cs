namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza.EditOggetti
{
	...
	public partial class Edit : ReservedBasePage
	{
		...
		public string GetUrlDownload()
		{
			...
			if (PdfCompilabile)
			{
				path = this._pathUtils.Reserved.InserimentoIstanza.GetUrlDownloadPdfCompilabile(this.IdComune, this.UserAuthenticationResult.Token, this.Software, codiceOggetto, this.IdDomanda);
			}else
			{
				path = this._pathUtils.Reserved.InserimentoIstanza.GetUrlDownloadOggetto(this.IdComune, this.UserAuthenticationResult.Token, this.Software, codiceOggetto, this.IdDomanda);
			}
		...
		public string GetUrlUpload()
		{
			...
			var path = this._pathUtils.Reserved.InserimentoIstanza.EditOggetti.GetUrlUpload(this.IdComune, this.UserAuthenticationResult.Token, this.Software, this.IdAllegato, this.TipoAllegato, this.IdDomanda, nomeFile, CodiceOggetto).Substring(1);
