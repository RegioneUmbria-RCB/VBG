...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
	public partial class GestioneStradario : IstanzeStepPage
	{
		...
		{
			LabeledControlBase	_controlloInput;
			...
			public ConfigurazioneCampiStradario(LabeledControlBase controlloInput, DataControlField colonna, bool obbligatorio, string etichetta, bool visibile)
			{
			...
			public void ApplicaCriteriDiVisibilita()
			{
				...
				this._controlloInput.Descrizione = this._colonna.HeaderText = this._etichetta;

				if (this._obbligatorio && !this._controlloInput.Descrizione.EndsWith("*"))
					this._controlloInput.Descrizione += " *";
			}
