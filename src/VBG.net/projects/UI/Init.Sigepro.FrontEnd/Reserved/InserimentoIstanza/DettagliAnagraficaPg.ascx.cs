    ...
    public partial class DettagliAnagraficaPg : DettagliAnagraficaControl
    {
        ...
        protected void cmdConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ValidaComune(hidProvinciaCciaa, "La provincia CCIAA non è valida", c => {
                ...
                ValidaComune(hidComuneRegTrib, "Il comune Reg. Trib. non è valido", c =>
                {
                ...
                ValidaComune(hidComuneSL, "Il comune della sede legale non è valido", c => {
                ...
                ValidaComune(hidComuneCorrispondenza, "Il comune per la corrispondenza non è valido", c => {
