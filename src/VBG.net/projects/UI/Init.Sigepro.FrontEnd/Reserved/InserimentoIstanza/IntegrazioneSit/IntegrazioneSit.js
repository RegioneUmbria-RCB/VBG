define(['jquery', 'json', 'jquery.ui'], function ($,JSON) {
    ...
    var RicercaStradarioServerInterface = function (serviceUrl, idComune, software, token) {
        ...
        this.valida = function (validazioneCommand) {
            ...
            $.ajax({
                url: self._serviceUrl + "/ValidaCampo?idcomune=" + self._idcomune + "&software=" + self._software + "&token=" + self._token,
                type: "POST",
                async: false,
        ...
        this.getListaCampi = function (getListaCampiCommand) {
            ...
            $.ajax({
                url: self._serviceUrl + "/GetListaCampi?idcomune=" + self._idcomune + "&software=" + self._software + "&token=" + self._token,
                type: "POST",
                async: false,
                contentType: "application/json; charset=utf-8",
                dataType: "json",
