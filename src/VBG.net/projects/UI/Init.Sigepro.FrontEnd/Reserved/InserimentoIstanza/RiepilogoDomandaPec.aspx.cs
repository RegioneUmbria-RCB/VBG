...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
	public partial class RiepilogoDomandaPec : IstanzeStepPage
	{
		...
		public override void DataBind()
		{
			...
			hlModelloDomanda.NavigateUrl = String.Format("~/Reserved/InserimentoIstanza/DownloadOggettoCompilabile.ashx?IdComune={0}&Token={1}&Software={2}&CodiceOggetto={3}&IdPresentazione={4}&Fmt={5}",
														IdComune,
