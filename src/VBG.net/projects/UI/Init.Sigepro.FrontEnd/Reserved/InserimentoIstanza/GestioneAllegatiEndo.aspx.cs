	...
	public partial class GestioneAllegatiEndo : IstanzeStepPage
	{
		...
		*/
		public override void DataBind()
		{
			...
			ddlTipoAllegato.Item.DataSource = dataSource;
		...
		private string GetLinkDownloadFile(DocumentoDomanda allegatoEndo)
		{
			...
			return _pathUtils.Reserved.GetUrlMostraOggettoFo(IdComune, UserAuthenticationResult.Token, Software, allegatoEndo.AllegatoDellUtente.CodiceOggetto, IdDomanda);
		}
		...
		{
			this.Master.Redirect.RedirectToPaginaCompilazioneOggetti(IdComune, Software, UserAuthenticationResult.Token, IdDomanda, e.IdAllegato, PathUtils.UrlParametersValues.TipoAllegatoEndo);
		}
