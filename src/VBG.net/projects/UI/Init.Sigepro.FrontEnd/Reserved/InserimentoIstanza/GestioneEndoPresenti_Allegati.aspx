...
<%@ Register TagPrefix="cc2" Namespace="Init.Sigepro.FrontEnd.WebControls.Common"
...
<asp:Content ID="Content1" ContentPlaceHolderID="stepContent" runat="server">
	...
	<cc2:AttributiAllegato runat="server" ID="ltrLegendaAttributi" Legenda="true" NascontiNoteCompilazioneInLegenda="true" StaccoDoppio="false"  />
			...
			<asp:TemplateField HeaderText="Allegato">
				<ItemTemplate>
					<div style="text-align: justify">
						...
						<i><asp:Literal runat="server" ID="ltrRiferimentiDocumento" Text='<%# Eval("RiferimentiDocumento") %>' /></i>
					</div>
				</ItemTemplate>
			</asp:TemplateField>
