...
<asp:Content ID="Content2" ContentPlaceHolderID="phContenuto" runat="server">
	...
	<div id="benvenuto">
		...
		<h2>Nell’area informativa dello sportello dove gli imprenditori possono avviare o sviluppare un’impresa e ricevere tutti i chiarimenti sui requisiti, la modulistica e gli adempimenti necessari.
			...
			<ul class="tipiRicerca">
				...
				<%if (this._configurazione.Testi.FrameCentrale.Link1.Visibile){ %>
					<li id="imageRicercaInt">
						<a href='<%= ResolveClientUrl("~/Contenuti/Step2.aspx") + "?alias=" + AliasComune + "&Software=" + Software%>'>
