define(['jquery', 'app/autocompleteHelper', 'json', 'jquery.ui'], function ($, AutocompleteHelper, JSON) {
    ...
    function GestioneAutorizzazioniBootstrapper() {
        return {
            bootstrap: function (controlli, settings) { return new GestioneAutorizzazioni(controlli, settings); }
        };
    }

    return new GestioneAutorizzazioniBootstrapper();
});