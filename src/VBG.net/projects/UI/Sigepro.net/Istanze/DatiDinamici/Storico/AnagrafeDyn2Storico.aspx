<%@ Page Language="C#" MasterPageFile="~/SigeproNetMaster.master" AutoEventWireup="true" CodeBehind="AnagrafeDyn2Storico.aspx.cs" Inherits="Sigepro.net.Istanze.DatiDinamici.Storico.AnagrafeDyn2Storico" Title="Storico schede" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
	<div class="Informazioni">
		...
		<div>
			<span class="Etichetta">Anagrafica</span>
			<span class="Valore"><asp:Literal runat="server" ID="ltrAnagrafica"/></span>
		</div>
		<div>
