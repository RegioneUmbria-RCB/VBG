...
namespace Sigepro.net.WebServices.WsAreaRiservata.Classes
{
	public partial class AreaRiservataServiceBase
	{
		...
		{
            return new AlberoprocService().GetSottonodiIntervento(token, software, idNodo, ambitoRicerca, livelloAutenticazione);
		}
		[WebMethod]
		...
		{
			return new AlberoprocService().GetSottonodiInterventoDaIdAteco(token, software, idNodoPadre, idAteco,ambitoRicerca, livelloAutenticazione);
		}
