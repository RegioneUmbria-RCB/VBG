...
namespace SIGePro.Net.WebServices.WsSIGePro
{
    ...
    public interface IProtocollazioneService
    {
        ...
        DatiProtocolloRes ProtocollazioneIstanza(string token, string codiceIstanza, int source);
        ...
        DatiProtocolloRes ProtocollazioneMovimento(string token, string codiceMovimento);
