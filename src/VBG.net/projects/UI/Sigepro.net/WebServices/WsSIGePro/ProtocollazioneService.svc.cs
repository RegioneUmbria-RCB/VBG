    ...
    public class ProtocollazioneService :  IProtocollazioneService
    {
        ...
        public DatiProtocolloRes ProtocollazioneIstanza(string token, string codiceIstanza, int source)
        {
            ...
            try
            {
                ...
                return this.Protocollazione(token, software, codiceComune, source, ProtocolloEnum.AmbitoProtocollazioneEnum.DA_ISTANZA, istanza, null, null, authInfo);
            }
            catch (Exception ex)
            {
        ...
        public DatiProtocolloRes ProtocollazioneMovimento(string token, string codiceMovimento)
        {
            ...
            try
            {
                ...
                return Protocollazione(token, software, codiceComune, (int)ProtocolloEnum.Source.PROT_IST_MOV_AUT_BO, ProtocolloEnum.AmbitoProtocollazioneEnum.DA_MOVIMENTO, istanza, movimento, null, authInfo);
            }
            catch (Exception ex)
            {
        ...
        public DatiFascicolo FascicolazioneMovimento(string token, string codiceMovimento)
        {
            ...
            try
            {
                ...
                return Fascicolazione(token, software, codiceComune, (int)ProtocolloEnum.SourceFascicolazione.FASC_IST_MOV_AUT_BO, ProtocolloEnum.AmbitoProtocollazioneEnum.DA_MOVIMENTO, istanza, movimento, null, authInfo);
            }
            catch (Exception ex)
            {
        ...
        private DatiFascicolo Fascicolazione(string token, string software, string codiceComune, int source, ProtocolloEnum.AmbitoProtocollazioneEnum ambito = ProtocolloEnum.AmbitoProtocollazioneEnum.NESSUNO, Istanze istanza = null, Init.SIGePro.Data.Movimenti movimento = null, DatiFasc file = null, AuthenticationInfo authInfo = null, string idProtocollo = null, string numeroProtocollo = null, string annoProtocollo = null)
        {
            ...
            using (var mgr = new ProtocolloMgr(authInfo, software, codiceComune, ambito, istanza, movimento))
                return mgr.Fascicola(file, source, idProtocollo, numeroProtocollo, annoProtocollo);
        }

        private DatiProtocolloRes Protocollazione(string token, string software, string codiceComune, int source, ProtocolloEnum.AmbitoProtocollazioneEnum ambito, Istanze istanza = null, Init.SIGePro.Data.Movimenti movimento = null, Dati dati = null, AuthenticationInfo authInfo = null)
        {
            if (authInfo == null)
                authInfo = this.CheckToken(token);
