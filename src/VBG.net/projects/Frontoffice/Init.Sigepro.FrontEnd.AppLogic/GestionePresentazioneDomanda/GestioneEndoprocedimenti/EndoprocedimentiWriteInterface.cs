namespace Init.Sigepro.FrontEnd.AppLogic.GestionePresentazioneDomanda.GestioneEndoprocedimenti
{
	...
	public class EndoprocedimentiWriteInterface : IEndoprocedimentiWriteInterface
	{
		...
		public void AggiungiOAggiorna(int codice, string descrizione, bool principale, int? codiceNatura, string descrizionenatura, bool facoltativo, int binariodipendenze, bool permetteVerificaAcquisizione)
		{
			var nuovo = false;
