...
{
	internal class LogicaSincronizzazioneAllegatiIntervento
	{
		IInterventiAllegatiRepository _interventiAllegatiRepository;
		DomandaOnline _domanda;

		internal LogicaSincronizzazioneAllegatiIntervento(DomandaOnline domanda, IInterventiAllegatiRepository interventiAllegatiRepository)
		{
