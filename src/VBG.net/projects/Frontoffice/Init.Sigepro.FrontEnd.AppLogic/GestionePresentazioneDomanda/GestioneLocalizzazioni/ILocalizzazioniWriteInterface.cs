...
namespace Init.Sigepro.FrontEnd.AppLogic.GestionePresentazioneDomanda.GestioneLocalizzazioni
{
	public class NuovaLocalizzazione
	{
		...
		public NuovaLocalizzazione(int codiceStradario, string indirizzo, string civico)
		{
	...
	public class NuovoRiferimentoCatastale
	{
		...
		public NuovoRiferimentoCatastale(string codTipoCatasto, string tipoCatasto, string foglio, string particella, string sub = "")
		{
