...
namespace Init.Sigepro.FrontEnd.AppLogic.DatiDinamici.DataAccess
{
	public class Dyn2DataAccessProvider : IDyn2DataAccessProvider
	{
		...
		public Dyn2DataAccessProvider(DomandaOnline domanda, int idModello, IIstanzeManager istanzeMgr, ITokenApplicazioneService tokenApplicazioneService)
		{
			this._domanda = domanda;
			this._aliasComune = domanda.ReadInterface.AltriDati.AliasComune;
			this._dapImpl = new Dyn2DataAccessProviderImpl(domanda, idModello);
		...
		public Dyn2DataAccessProvider(DomandaOnline domanda, int idModello, ITokenApplicazioneService tokenApplicazioneService)
			: this(domanda, idModello, new Dyn2IstanzeManager(new IstanzaSigeproAdapter(domanda.ReadInterface)), tokenApplicazioneService)
		{
		}
		...
		{
			return _tokenApplicazioneService.GetToken(this._aliasComune);
		}
