...
namespace Init.Sigepro.FrontEnd.AppLogic.STC
{
	...
	{
		NotificaAttivitaResponse NotificaAttivita(NotificaAttivitaRequest request);
		InserimentoPraticaResponse InserimentoPratica(InserimentoPraticaRequest request , string pecSportello);
