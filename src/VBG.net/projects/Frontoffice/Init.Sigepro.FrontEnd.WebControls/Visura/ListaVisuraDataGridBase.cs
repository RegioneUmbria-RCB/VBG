	...
	public abstract class ListaVisuraDataGridBase : GridView, IDatabaseSoftwareControl
	{
		...
		public override object DataSource
		{
			...
			set
			{
				...
				SessionDataSource = (List<PraticaPresentata>)value;
			}
		}

		protected List<PraticaPresentata> SessionDataSource
		{
			get { return (List<PraticaPresentata>)Context.Session["VisuraDataGridDataSource"]; }
			set { Context.Session["VisuraDataGridDataSource"] = value; }
		}
		...
		{
			string idPraticaSelezionata = this.DataKeys[this.SelectedIndex].Value.ToString();
		...
		private void VisuraDataGrid_Init(object sender, EventArgs e)
		{
			...
			m_localizzazione.DataField = "Localizzazione";
