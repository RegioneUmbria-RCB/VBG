...
using MovimentiTest.TestSegnapostoSchedeDinamiche;
...
namespace MovimentiTest.InvioIstanze
{
	...
	public class TestInvioConStc
	{
		...
		public void Quando_invio_una_domanda_e_si_verifica_un_errore_di_trasferimento_l_esito_e_InvioFallito()
		{
			...
			stcMock.Setup(x => x.InserimentoPratica(It.IsAny<InserimentoPraticaRequest>(), It.IsAny<string>()))
			...
			IInvioDomandaStrategy invioDomandaStrategy = new InvioDomandaSTCStrategy(comuniService, stcMock.Object, istanzaStcAdapter);
		...
		private DomandaOnline MockDomandaOnline()
		{
			...
			domanda.WriteInterface.AltriDati.ImpostaIntervento( 1, "test", null, null);
