...
namespace MovimentiTest.GestioneEndoprocedimenti.IncompatibilitaEndo
{
	...
	public class IncompatibilitaEndoDomandaTests
	{
		...
		public void Initialize()
		{
			...
			this._db.ISTANZEPROCEDIMENTI.AddISTANZEPROCEDIMENTIRow(1, "Endo 1", false, 0, String.Empty, false, String.Empty, DateTime.Now, 0, 0, String.Empty, false, false, String.Empty, String.Empty, -1);
			this._db.ISTANZEPROCEDIMENTI.AddISTANZEPROCEDIMENTIRow(2, "Endo 2", false, 0, String.Empty, false, String.Empty, DateTime.Now, 0, 0, String.Empty, false, false, String.Empty, String.Empty, -1);
