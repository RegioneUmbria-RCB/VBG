...
{
	public class FirmaDigitalmenteAllegatoMovimento : Command
	{
		...
		public FirmaDigitalmenteAllegatoMovimento(string idComune, int idMovimento, int codiceOggetto, string nomeFile)
		{
