...
namespace Init.SIGePro.Protocollo.DocPro.Services
{
    public class DocProProtocollazioneService
    {
        ...
        private ProxyProtDocPro CreaWebService()
        {
            try
            {
                _logs.Debug("Creazione del webservice di protocollazione DocPro");
                ...
                var ws = new ProxyProtDocPro { Url = _endPointAddress };
                ws.Timeout = 600000;

                _logs.Debug("Fine creazione del webservice DOCPRO");
