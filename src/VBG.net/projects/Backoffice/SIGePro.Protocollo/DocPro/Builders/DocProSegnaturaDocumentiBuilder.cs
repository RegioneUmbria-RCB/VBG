...
{
    /// <summary>
    /// La classe è stata chiamata DocProSegnaturaDocumentiBuilder perchè è la parte riguardante i documenti della segnatura da inviare al web service, in realtà però 
    ...
    /// </summary>
    public class DocProSegnaturaDocumentiBuilder
    {
        ...
        public DocProSegnaturaDocumentiBuilder(List<ProtocolloAllegati> listAllegati, string tipoDocPrincipale, string tipoDocAllegato)
        {
