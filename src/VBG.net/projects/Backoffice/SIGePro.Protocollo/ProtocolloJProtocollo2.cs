...
namespace Init.SIGePro.Protocollo
{
    public class PROTOCOLLO_JPROTOCOLLO2 : ProtocolloBase
    {
        ...
        public override DatiProtocolloRes Protocollazione(DatiProtocolloIn protoIn)
        {
            ...
            var adapterDocumenti = new DocumentiAdapter(service, protoIn.Allegati);
            adapterDocumenti.Adatta(datiRes.NumeroProtocollo, datiRes.AnnoProtocollo, Operatore);
        ...
        public override AllOut LeggiAllegato()
        {
            ...
            return new AllOut
            {
                ...
                Serial = response.documento.titolo
            };
        }
