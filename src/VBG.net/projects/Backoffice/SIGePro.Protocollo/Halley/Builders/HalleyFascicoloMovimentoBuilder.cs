...
namespace Init.SIGePro.Protocollo.Halley.Builders
{
    public class HalleyFascicoloMovimentoBuilder : IFascicoloHalleyBuilder
    {
        ...
        public HalleyFascicoloMovimentoBuilder(string numeroProtocollo, string annoProtocollo, ProtocolloLogs log, HalleyVerticalizzazioneParametriAdapter vert, string tokenDizionario)
        {
        ...
        public FascicoliFascicolo GetDatiFascicolo()
        {
            ...
            try
            {
                var srv = new HalleyDizionarioService(_log, _vert.UrlWsDizionario);
