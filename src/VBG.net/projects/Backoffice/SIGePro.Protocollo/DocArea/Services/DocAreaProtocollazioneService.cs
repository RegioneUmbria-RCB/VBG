...
namespace Init.SIGePro.Protocollo.DocArea.Services
{
    public class DocAreaProtocollazioneService
    {
        ...
        private DocAreaProxy CreaWebService()
        {
            try
            {
        ...
        internal void InserisciAllegatiDaMovimentoAvvio(Istanze istanza, DataBase db, string idComune, List<ProtocolloAllegati> listAllegati)
        {
            ...
            {
                throw new Exception(String.Format("PROBLEMA DURANTE L'INSERIMENTO DELL'ALLEGATO DEL MOVIMENTO DI AVVIO", ex.Message), ex);
            }
        }

        internal void InserisciAllegati(List<ProtocolloAllegati> listAllegati, string token, string userName, bool inviaComeAttachmentID)
        {
            try
            {
                using (var ws = CreaWebService())
            ...
            {
                throw new Exception(String.Format("ERRORE GENERATO DURANTE L'UPLOAD DEL FILE", ex.Message), ex);
            }
        }
