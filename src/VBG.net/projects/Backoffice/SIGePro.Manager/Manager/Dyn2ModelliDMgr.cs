...
namespace Init.SIGePro.Manager
{
	...
	public partial class Dyn2ModelliDMgr : IDyn2DettagliModelloManager
    {
		...
		public void ImpostaRigaMultipla(string idComune, int idModello, int indiceRiga, bool multipla)
		{
			...
			try
			{
				...
				*/
				...
				try
				{
					...
					sql = "update dyn2_modellid set flg_multiplo = 1 where idcomune={0} and fk_d2mt_id = {1} and posverticale = {2}";
