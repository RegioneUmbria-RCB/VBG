...
namespace Init.SIGePro.Authentication
{
    ...
    public class AuthenticationManager
    {
        ...
        /*public void  (string alias)
        {
            var user = Settings.Default.SigeproSecurityUsername;
            var pass = Settings.Default.SigeproSecurityPassword;

            var authInfo = Login(alias, user, pass, ContextType.ExternalUsers);

            var urlBackend = GetApplicationInfoValue("WSHOSTURL_JAVA");
