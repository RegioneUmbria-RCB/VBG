...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
	public partial class ARFileUpload : System.Web.UI.UserControl
	{
		...
		private void MostraVistaDettaglio()
		{
			...
			hlDownloadFile.NavigateUrl = $"~/Reserved/MostraOggettoFo.ashx?IdComune={IdComune}&Software={Software}&CodiceOggetto={DataSource.CodiceOggetto}&IdPresentazione={IdPresentazione}";
