        ...
        <asp:View runat="server" ID="dettaglioView">
            ...
            <div class="form-small">
                ...
                <div class="row">
                    ...
                    <asp:Button ID="cmdAdd" runat="server" Text="Aggiungi" OnClick="cmdAdd_Click" CssClass="btn btn-primary" />
                    <asp:LinkButton ID="cmdReset" runat="server" Text="Annulla" CausesValidation="False" CssClass="btn btn-default"
