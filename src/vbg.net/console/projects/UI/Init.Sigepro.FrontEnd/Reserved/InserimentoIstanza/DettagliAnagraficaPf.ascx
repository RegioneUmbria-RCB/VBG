...
<script type="text/javascript">
    require(['jquery', 'app/ricercaComuni', 'app/ricercaProvincia', 'app/verificaCf', 'app/ricerca-albi-professionali/ricerca-albo', 'jquery.ui'], function ($, RicercaComuni, RicercaProvincia, VerificaCf, ricercaAlbo) {
...
<div class="form-small">
    ...
    <fieldset class='<%=ClasseCampo(ResidenzaVisible)%>'>
        ...
        <div class="row">
            <ar:Autocomplete runat="server" ID="acComuneResidenza" MaxLength="40" Label="Comune" BtSize="Col4" />
            <ar:TextBox runat="server" ID="Indirizzo" MaxLength="100" Label="Indirizzo" BtSize="Col8" />
        </div>

        <div class="row">
            <ar:TextBox runat="server" ID="Citta" MaxLength="100" Label="Località/Frazione" BtSize="Col6" />
            <ar:TextBox runat="server" ID="Cap" MaxLength="100" Label="Cap" BtSize="Col6" />
        </div>
    </fieldset>
