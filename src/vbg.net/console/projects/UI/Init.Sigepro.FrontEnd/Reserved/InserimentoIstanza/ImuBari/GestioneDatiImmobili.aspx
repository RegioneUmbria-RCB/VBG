 <%@ Page Title="Gestione Immobili IMU" Language="C#" MasterPageFile="~/Reserved/InserimentoIstanza/InserimentoIstanzaMaster.Master" AutoEventWireup="true" CodeBehind="GestioneDatiImmobili.aspx.cs" Inherits="Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza.ImuBari.GestioneDatiImmobili" %>
<%@ MasterType VirtualPath="~/Reserved/InserimentoIstanza/InserimentoIstanzaMaster.Master" %>
<%@ Register src="~/Reserved/InserimentoIstanza/ImuBari/GestioneDatiImmobili_Dettagli.ascx" tagname="GestioneDatiImmobili_Dettagli" tagprefix="uc1" %>
