        ...
        <asp:View runat="server" ID="allegaFileView">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <asp:FileUpload runat="server" ID="fuRiepilogo" CssClass="form-control" />
                ...
                <div class="panel-body">
                    ...
                    <div>
                        <asp:Button runat="server" ID="cmdFirma" Text="Firma online"
                            OnClick="cmdFirma_Click" CssClass="btn btn-primary" />

<%--                        <asp:Button runat="server" ID="cmdFirmaCidPin" Text="Firma con CID/PIN"
                            OnClick="cmdFirmaCidPin_Click" CssClass="btn btn-primary" />

                        <asp:Button runat="server" ID="cmdFirmaGrafometrica" Text="Firma grafometrica"
                            OnClick="cmdFirmaGrafometrica_Click" CssClass="btn btn-primary" />--%>

                        <asp:Button runat="server" ID="cmdFirnaConDispositivoEsterno" Text="Firma con dispositivo esterno"
                            OnClick="cmdFirnaConDispositivoEsterno_Click" CssClass="btn btn-primary" />

                        <asp:Button runat="server" ID="cmdAllegaAltroFile" OnClick="cmdFirnaConDispositivoEsterno_Click" CssClass="btn btn-default allegato-ok" Text="Sostituisci il file allegato" />
                    </div>
