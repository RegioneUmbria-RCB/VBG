<%@ Page Title="" Language="C#" EnableViewState="false" MasterPageFile="~/AreaRiservataPopupMaster.Master"
	AutoEventWireup="true"  CodeBehind="MostraDettagliEndoB.aspx.cs" Inherits="Init.Sigepro.FrontEnd.Public.MostraDettagliEndoB" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
	...
	<asp:Panel runat="server" ID="pnlDatiEndo" >
		...
		<div id="accordion" class="popupDettagliEndo inputForm dettagliIntervento panel-group" role="tablist" aria-multiselectable="true">
			
            <asp:Panel runat="server" ID="pnlSchedaCart">
				<h3>
					<a href="#">Scheda regionale</a>
				</h3>
				<div>
					<asp:Literal runat="server" ID="ltrSchedaCart" />
				</div>
			</asp:Panel>
