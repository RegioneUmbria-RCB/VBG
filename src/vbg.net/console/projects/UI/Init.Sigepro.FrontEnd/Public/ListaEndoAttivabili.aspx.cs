...
namespace Init.Sigepro.FrontEnd.Public
{
	public partial class ListaEndoAttivabili : BasePage
	{
		...
		{
            var codiceComune = IdComune; // Non è corretto, in teoria dovrebbe essere il codice del comune per cui si presenta la domanda
			var listaEndoIntervento = _endoprocedimentiRepository.WhereInterventoIs(Intervento, codiceComune);
