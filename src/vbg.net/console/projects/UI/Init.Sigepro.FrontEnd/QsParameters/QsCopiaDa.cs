...
{
    public class QsCopiaDa : BaseQuerystringParameter<int>
    {
        public const string QuerystringParameterName = "copia-da";

        public QsCopiaDa(int value) :
            base(value.ToString())
        {
        }

        public QsCopiaDa(NameValueCollection qs) :
            base(qs)
        {
        }
