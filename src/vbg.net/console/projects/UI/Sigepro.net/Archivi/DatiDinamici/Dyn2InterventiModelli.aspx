<%@ Page Language="C#" MasterPageFile="~/SigeproNetMaster.master" AutoEventWireup="true" Inherits="Sigepro.net.Archivi.DatiDinamici.Dyn2InterventiModelli" Title="Modelli dinamici" CodeBehind="Dyn2InterventiModelli.aspx.cs"%>
...
<fieldset>
	<div class="Informazioni">
	    <asp:Label CssClass="Etichetta" ID="lblTitolo1" runat="server" Text="Intervento:"></asp:Label>
	...
	<asp:MultiView runat="server" ID="multiView" ActiveViewIndex="0" OnActiveViewChanged="multiView_ActiveViewChanged">
		<asp:View runat="server" ID="listaView">
			<fieldset>
			<div>
			    <init:GridViewEx runat="server" ID="gvLista" AutoGenerateColumns="False" DataKeyNames="CodiceIntervento,FkD2mtId" DatabindOnFirstLoad="True" AllowSorting="True" DefaultSortDirection="Ascending" DefaultSortExpression="" OnRowDeleting="gvLista_RowDeleting" OnRowDataBound="gvLista_RowDataBound" >
