<%@ Page Language="C#" MasterPageFile="~/SigeproNetMaster.master" AutoEventWireup="true" Inherits="Sigepro.net.Archivi.DatiDinamici.Dyn2TipiMovimentoModelli" Title="Modelli dinamici" CodeBehind="Dyn2TipiMovimentoModelli.aspx.cs"  %>
...
<fieldset>
	<div class="Informazioni">
	    <asp:Label CssClass="Etichetta" ID="lblTitolo1" runat="server" Text="Tipo movimento:"></asp:Label>
	...
	<asp:MultiView runat="server" ID="multiView" ActiveViewIndex="0" OnActiveViewChanged="multiView_ActiveViewChanged">
		<asp:View runat="server" ID="listaView">
			<fieldset>
			<div>
			    <init:GridViewEx runat="server" ID="gvLista" AutoGenerateColumns="False" DataKeyNames="Tipomovimento,FkD2mtId" DatabindOnFirstLoad="True" AllowSorting="True" DefaultSortDirection="Ascending" DefaultSortExpression="" OnRowDeleting="gvLista_RowDeleting" OnRowDataBound="gvLista_RowDataBound" >
				    ...
				    <EmptyDataTemplate>
					    <asp:Label ID="Label6" runat="server">Non esiste nessuna scheda collegata al movimento</asp:Label>
				    </EmptyDataTemplate>
                    <Columns>
