    ...
    public class ProtocollazioneService : IProtocollazioneService
    {
        ...
        public DatiProtocolloRes ProtocollazioneMovimento(string token, string codiceMovimento, DatiMittenti mittenti = null)
        {
            ...
            try
            {
                ...
                return Protocollazione(token, software, codiceComune, (int)ProtocolloEnum.Source.PROT_IST_MOV_AUT_BO, ProtocolloEnum.AmbitoProtocollazioneEnum.DA_MOVIMENTO, istanza, movimento, dati, authInfo);
            }
            catch (Exception ex)
            {
