...
namespace Init.Sigepro.FrontEnd.Bari.DenunceTARES.DTOs.Converters
{
	...
	public class DatiUtenzaDomesticaResponseTypeToUtenzaDomesticaDenunciaTaresDto: IMapTo<datiUtenzaDomesticaResponseType, UtenzaDomesticaDenunciaTaresDto>
	{
		...
		public DatiUtenzaDomesticaResponseTypeToUtenzaDomesticaDenunciaTaresDto(IMapTo<indirizzoComuneType, IndirizzoDenunciaTares> indirizzoMapper, IMapTo<datiCatastaliNewType, DatiCatastaliDenunciaTares> datiCatastaliMapper, IMapTo<occupanteImmobileType, OccupanteImmobileDenunciaTares> occupanteImmobileMapper)
		{
			this._indirizzoMapper = indirizzoMapper;
			this._datiCatastaliMapper = datiCatastaliMapper;
            this._occupanteImmobileMapper = occupanteImmobileMapper;
		}
