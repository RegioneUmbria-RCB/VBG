...
namespace Init.Sigepro.FrontEnd.Bari.IMU.DTOs
{
	public class IndirizzoImuDto
	{
		...
		public static IndirizzoImuDto Vuoto()
		{
			return new IndirizzoImuDto(String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, String.Empty, String.Empty);
		}

		[Obsolete("Utilizzare solo per la serializzazione")]
		public IndirizzoImuDto()
		{
		}

		public IndirizzoImuDto(string cap, string codiceVia, string via, string civico, string esponente, string palazzina, string scala, string piano, string interno, string suffisso)
		{
			this.Via = via;
