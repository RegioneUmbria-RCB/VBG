...
namespace Init.Sigepro.FrontEnd.AppLogic.GenerazioneDocumentiDomanda.GenerazioneRiepilogoDomanda.GestioneSostituzioneSegnapostoRiepilogo
{
    ...
    {
        string GeneraHtml(IDatiDinamiciRiepilogoReader datiDinamiciReader, int idScheda);
        string GeneraHtml(IDatiDinamiciRiepilogoReader datiDinamiciReader, int idScheda, int indiceMolteplicita);
