...
namespace Init.Sigepro.FrontEnd.AppLogic.GestioneVisuraIstanza.VisuraSigepro
{
    internal class WsDettaglioPraticaRepository// : IDettaglioPraticaRepository
    {
        ...
        IVisuraIstanzeServiceCreator _istanzeServiceCreator;

        internal WsDettaglioPraticaRepository(IConfigurazioneVbgRepository configurazioneVbgRepository, IVisuraIstanzeServiceCreator istanzeServiceCreator)
        {
