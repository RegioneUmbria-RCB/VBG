...
namespace Init.Sigepro.FrontEnd.AppLogic.GestionePresentazioneDomanda.GestioneEndoprocedimenti
{
	public interface IEndoprocedimentiWriteInterface
	{
		...
		void AggiungiOAggiorna(int codice, string descrizione, bool principale, int? codiceNatura, string descrizionenatura, bool facoltativo, int binariodipendenze, bool permetteVerificaAcquisizione, bool tipoTitoloObbligatorio);
