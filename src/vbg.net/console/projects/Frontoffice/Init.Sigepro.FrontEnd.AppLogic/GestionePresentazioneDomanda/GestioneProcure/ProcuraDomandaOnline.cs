...
namespace Init.Sigepro.FrontEnd.AppLogic.GestionePresentazioneDomanda.GestioneProcure
{
	public class ProcuraDomandaOnline
	{
        ...
        public AllegatoProcura DocumentoIdentita { get; private set; }


        public ProcuraDomandaOnline(SoggettoProcura procurato, SoggettoProcura procuratore, AllegatoProcura allegato, AllegatoProcura documentoIdentita)
		{
