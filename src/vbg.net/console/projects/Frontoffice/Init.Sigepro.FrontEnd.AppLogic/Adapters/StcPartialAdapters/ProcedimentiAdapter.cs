...
namespace Init.Sigepro.FrontEnd.AppLogic.Adapters.StcPartialAdapters
{
	internal class ProcedimentiAdapter : IStcPartialAdapter
	{
        ...
        public ProcedimentiAdapter(IAliasResolver aliasResolver)
        {
				...
				proc.documenti = _readInterface.Documenti
													...
													.Union(
														_readInterface
															...
															.Select(x => x.Riferimenti.Allegato.ToDocumentiType("Documento comprovante il possesso del titolo \"" + endo.Descrizione + "\"", this._aliasResolver))
													)
													.ToArray();
