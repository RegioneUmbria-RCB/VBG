...
namespace Init.Sigepro.FrontEnd.AppLogic.Adapters.StcPartialAdapters
{
	internal class AnagraficheHelper
	{
		...
		internal RuoloType AdattaRuolo(AnagraficaDomanda anagrafe)
		{
			...
			{
                // Nella console l'id ruolo non deve essere passato
		...
		internal PersonaGiuridicaType AdattaPersonaGiuridica(AnagraficaDomanda azienda, IFormeGiuridicheRepository formeGiuridicheRepository, AnagraficaDomanda legaleRappresentante = null)
		{
			...
			var pg = new PersonaGiuridicaType
			{
                ...
                naturaGiuridica = azienda.IdFormagiuridica.HasValue ? formeGiuridicheRepository.GetById(azienda.IdFormagiuridica.ToString()).FORMAGIURIDICA : String.Empty,
		...
		/// <returns></returns>
		internal AnagrafeType AdattaAnagrafica(AnagraficaDomanda anagrafe, IFormeGiuridicheRepository formeGiuridicheRepository)
		{
			if (anagrafe == null)
				return null;
			...
			{
				return new AnagrafeType { Item = AdattaPersonaGiuridica(anagrafe, formeGiuridicheRepository) };
			}
		}
	}
}
