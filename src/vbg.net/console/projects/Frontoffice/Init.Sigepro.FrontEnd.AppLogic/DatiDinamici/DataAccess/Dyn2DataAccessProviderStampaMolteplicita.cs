...
namespace Init.Sigepro.FrontEnd.AppLogic.DatiDinamici.DataAccess
{
	public class Dyn2DataAccessProviderStampaMolteplicita : IDyn2DataAccessProvider
	{
		...
		public Dyn2DataAccessProviderStampaMolteplicita(IFoDyn2DataAccessProvider dataAccessProvider, IIstanzeManager istanzeMgr, ITokenApplicazioneService tokenApplicazioneService)
		{
		...
		public Dyn2DataAccessProviderStampaMolteplicita(DomandaOnline domanda, int idModello, int limiteIndiceMolteplicita, ITokenApplicazioneService tokenApplicazioneService)
			: this(new Dyn2DataAccessProviderStampaMolteplicitaImpl(domanda, idModello, limiteIndiceMolteplicita), new Dyn2IstanzeManager(new IstanzaSigeproAdapter(domanda.ReadInterface)), tokenApplicazioneService)
		{
		}
		...
		{
            return (this._istanzeMgr as Dyn2IstanzeManager).GetQueryLocalizzazioni();
