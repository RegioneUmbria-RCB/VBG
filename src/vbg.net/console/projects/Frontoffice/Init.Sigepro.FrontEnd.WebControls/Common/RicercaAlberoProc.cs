	...
	public class RicercaAlberoProc : SearchWebControl /*, INamingContainer*/
	{
		...
		public override string ID
		{
			...
			set
			{
                ...
                m_level0.Style.Add("max-width", "600px");
                m_level1.Style.Add("max-width", "600px");
                m_level2.Style.Add("max-width", "600px");
                m_level3.Style.Add("max-width", "600px");
                m_level4.Style.Add("max-width", "600px");
                m_level5.Style.Add("max-width", "600px");
		...
		{
			return _alberoProcRepository.GetSottonodi(IdComune, Software, valore, new AmbitoRicercaAreaRiservata(false));
		}
	}
}