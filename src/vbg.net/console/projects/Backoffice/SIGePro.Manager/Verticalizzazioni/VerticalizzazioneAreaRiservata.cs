...
namespace Init.SIGePro.Verticalizzazioni
{
    ...
    public partial class VerticalizzazioneAreaRiservata : Verticalizzazione
    {
        ...
        {
            public static string UrlServiziMobile = "SERVIZI_MOBILE_URL";
            public static string AliasSportelloServiziMobile = "SERVIZI_MOBILE_ALIAS_SPORTELLO";
            public static string IdSchedaEstremiDocumento = "ID_SCHEDA_ESTREMI_DOCUMENTO";
            public static string StatoinizialeIstanza = "STATO_INIZIALE_ISTANZA";
            public static string IntestazioneCertificatoInvio = "INTESTAZIONE_CERTIFICATO_INVIO";
            public static string DimensioneMassimaAllegati = "DIMENSIONE_MASSIMA_ALLEGATI";
            public static int DimensioneMassimaAllegatiDefault = 10485760;  // 10mb
            public static string WarningDimensioneMassimaAllegatiDefault = "Attenzione! Il file allegato supera la dimensione massima consentita ({0} MB).";
            public static string WarningDimensioneMassimaAllegati = "WARNING_DIMENSIONE_MASSIMA_ALL";
            public static string DescrizioneDelegaATrasmettere = "DESCR_DELEGA_A_TRASMETTERE";
            public static string UsernameUtenteAnonimo = "USERNAME_UTENTE_ANONIMO";
            public static string PasswordUtenteAnonimo = "PASSWORD_UTENTE_ANONIMO";
            public static string CiviciNumerici = "CIVICI_NUMERICI";
            public static string EsponentiNumerici = "ESPONENTI_NUMERICI";
            public static string UrlLogo = "URL_LOGO";
            public static string NascondiNoteMovimento = "NASCONDI_NOTE_MOVIMENTO";
            public static string IntegrazioniNoUploadAllegati = "INTEGR.NO_UPLOAD_ALLEGATI";
            public static string IntegrazioniNoUploadRiepiloghiSchedeDinamiche = "INTEGR.NO_UPLOAD_RIEPILOGHI_SD";
            public static string IntegrazioniNoInserimentoNote = "INTEGR_NO_INSERIMENTO_NOTE";
            public static string IntegrazioniNoNomiAllegati = "INTEGR_NO_NOMI_ALLEGATI";
            public static string TecnicoInSoggettiCollegati = "TECNICO_IN_SOGGETTI_COLLEGATI";
            public static string FlagSchedeDinamicheFirmateInRiepilogo = "FL_SCHEDE_FIRMATE_IN_RIEPILOGO";
            public static string UrlVisuraIstanzaConsole = "URL_VISURA_ISTANZA_CONSOLE";
        }
        ...
        public int FlagSchedeDinamicheFirmateInRiepilogo
        {
            get { return GetInt(Constants.FlagSchedeDinamicheFirmateInRiepilogo).GetValueOrDefault(0); }
        }

        public string UrlVisuraIstanzaConsole => GetString(Constants.UrlVisuraIstanzaConsole);
    }
}
