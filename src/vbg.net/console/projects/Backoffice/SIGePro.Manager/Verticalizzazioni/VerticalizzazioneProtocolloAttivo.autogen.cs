...
namespace Init.SIGePro.Verticalizzazioni
{
    ...
    ***************************************************************************************************************************************/
    ...
    public partial class VerticalizzazioneProtocolloAttivo : Verticalizzazione
    {
        ...
        /// </summary>
        public string CreaCopiaFile
        {
            get { return GetString("CREA_COPIA_FILE"); }
            set { SetString("CREA_COPIA_FILE", value); }
        }

        public string CreaCopiaDescrFile
        {
            get { return GetString("CREACOPIA_DESCR_FILE"); }
            set { SetString("CREACOPIA_DESCR_FILE", value); }
        }
        ...
        /// </summary>
        public string InviaEmlPecArrivo
        {
            get { return GetString("INVIA_EML_PEC_ARRIVO"); }
            set { SetString("INVIA_EML_PEC_ARRIVO", value); }
        }
        ...
        /// </summary>
        public string AllegatiObbligatori
        {
            get { return GetString("ALLEGATI_OBBLIGATORI"); }
            set { SetString("ALLEGATI_OBBLIGATORI", value); }
        }
        ...
        /// </summary>
        public string DescrFileMaxLength
        {
            get { return GetString("DESCRFILE_MAXLENGTH"); }
            set { SetString("DESCRFILE_MAXLENGTH", value); }
        }
    }
}
