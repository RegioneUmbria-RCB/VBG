...
namespace Init.SIGePro.Verticalizzazioni
{
    ...
    ***************************************************************************************************************************************/
    ...
    public partial class VerticalizzazioneProtocolloPadoc : Verticalizzazione
    {
        ...
        /// <summary>
        /// Indicare quale metodo del web service deve invocare il componente di protocollazione. E' il valore che viene assegnato al parametro verb presente sull'url del ws. Può prendere solo si seguenti valori (case sensitive): register --> indica la sola registrazione del protocollo; register_insert --> indica la registrazione e successivamente la pratica viene inoltrata nelle Pratiche Trattate del protocollo. Di default (quindi non assegnata) assumerà il valore register.
        /// </summary>
        public string MetodoProto
        {
            get { return GetString("METODO_PROTO"); }
            set { SetString("METODO_PROTO", value); }
        }
