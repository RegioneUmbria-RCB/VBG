			...
			namespace Init.SIGePro.Verticalizzazioni
			{
				...
				***************************************************************************************************************************************/
				...
				public partial class VerticalizzazioneProtocolloSigedo : Verticalizzazione
				{
                    ...
                    /// <summary>
                    /// Questo parametro è richiesto obbligatoriamente sul metodo aggiungiAllegati del web service di protocollazione e fa da chiave, insieme a numero e anno protocollo, come riferimento di un determinato protocollo al quale vengono aggiunti documenti.
                    /// </summary>
                    public string TipoRegistro
                    {
                        get { return GetString("TIPOREGISTRO"); }
                        set { SetString("TIPOREGISTRO", value); }
                    }

                    /// <summary>
                    /// Questo parametro indica se deve essere utilizzata la funzionalità di presa in carico ed eseguito messa a disposizione dal web service di protocollazione con il metodo SmistamentoAction, se valorizzata a 1 la funzionalità verrà eseguita, con qualsiasi altro valore no.
                    ...
                    /// </summary>
                    public string UsaSmistamentoAction
                    {
                        get { return GetString("USA_SMISTAMENTOACTION"); }
                        set { SetString("USA_SMISTAMENTOACTION", value); }
                    }
				}
			}		