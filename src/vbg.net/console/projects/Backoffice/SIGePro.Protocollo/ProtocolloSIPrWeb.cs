...
using Init.SIGePro.Protocollo.SiprWeb.Protocollazione;
...
using Init.SIGePro.Protocollo.SiprWeb.LeggiProtocollo;
using Init.SIGePro.Manager;
using Init.SIGePro.Protocollo.WsDataClass;

namespace Init.SIGePro.Protocollo
{
    public class PROTOCOLLO_SIPRWEB : ProtocolloBase
    {
        ...
        public override DatiProtocolloRes Protocollazione(DatiProtocolloIn protoIn)
        {
            try
            {
                var verticalizzazione = new VerticalizzazioniConfiguration(_protocolloLogs, new VerticalizzazioneProtocolloSiprweb(DatiProtocollo.IdComuneAlias, DatiProtocollo.Software, DatiProtocollo.CodiceComune));
