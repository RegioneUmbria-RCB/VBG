...
using Init.SIGePro.Protocollo.InsielMercato.Protocollazione;
using Init.SIGePro.Protocollo.InsielMercato.LeggiProtocollo;
using Init.SIGePro.Protocollo.InsielMercato.LeggiClassifiche;
...
{
    public class PROTOCOLLO_INSIELMERCATO : ProtocolloBase
    {
        ...
        public override DatiProtocolloRes Protocollazione(DatiProtocolloIn protoIn)
        {
            ...
            var ufficio = GetUfficioRegistro(vert.Registro);
            ...
            var adapter = new ProtocollazioneAdapter(wrapper, datiAnagrafici, vert, ufficio, sequenza.Codicesequenza, DatiProtocollo);
