...
namespace Init.SIGePro.Protocollo.DocArea
{
...
#endif
    {
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/destinatariAggiuntivi", RequestNamespace = "http://tempuri.org/", ResponseNamespace = "http://tempuri.org/", Use = System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle = System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        [return: System.Xml.Serialization.XmlElementAttribute("DestinatariRet")]
        public DestinatariRet destinatariAggiuntivi(string strUserName, string strDST)
        {
            object[] results = this.Invoke("destinatariAggiuntivi", new object[] {
                    strUserName,
                    strDST});
            return ((DestinatariRet)(results[0]));
        }
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(Namespace = "http://tempuri.org/")]
    public partial class DestinatariRet
    {
