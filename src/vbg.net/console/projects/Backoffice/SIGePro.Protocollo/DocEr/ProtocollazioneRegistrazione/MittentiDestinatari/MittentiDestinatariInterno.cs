                    ...
                    { 
                        ...
                        {                 
                            ...
                            { 
                                ...
                                { 
                                    Identificativo = new IdentificativoType{ Text = new string[]{ _datiProto.AmministrazioniInterne[0].PROT_UO } },
                                    Denominazione = new DenominazioneType{ Text = new string[] { _datiProto.AmministrazioniInterne[0].AMMINISTRAZIONE } }
                                }
                            }
                        }, 
                        new AOOType{ CodiceAOO = new CodiceAOOType{ Text = new string[]{ _vert.CodiceAoo } } }
