...
namespace Init.SIGePro.Protocollo.InsielMercato.Services
{
        ...
        public recordIdentifier Protocolla(protocolInsertRequest request)
        {
            try
            {
                using (var ws = CreaWebService())
                {
                    ...
                    if (response == null)
                        throw new Exception("LA RISPOSTA AL METODO INSERISCI PROTOCOLLO NON E' STATA VALORIZZATA");
        ...
        public protocolDetail LeggiProtocollo(protocolDetailRequest request)
        {
            try
            {
                using (var ws = CreaWebService())
                {
                    ...
                    if (response == null)
                        throw new Exception("LA RISPOSTA DAL METODO LEGGI PROTOCOLLO NON E' STATA VALORIZZATA");
