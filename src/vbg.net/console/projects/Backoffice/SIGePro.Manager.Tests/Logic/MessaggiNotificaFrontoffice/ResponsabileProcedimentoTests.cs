// -----------------------------------------------------------------------
// <copyright file="ResponsabileProcedimentoTests.cs" company="">
...
namespace SIGePro.Manager.Tests.Logic.MessaggiNotificaFrontoffice
{
	...
	/// </summary>
	[TestClass]
	public class ResponsabileProcedimentoTests
	{
		...
		public void Il_codicefiscale_ed_email_vengono_letti_da_dati_dell_operatore()
		{
			...
			{
				CODICERESPONSABILEPROC = "1"
			};

			var testClass = ResponsabileProcedimento.FromIstanza(istanza, this._repository);
