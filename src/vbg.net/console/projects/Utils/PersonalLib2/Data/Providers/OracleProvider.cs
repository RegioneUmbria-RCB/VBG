namespace PersonalLib2.Data.Providers
{
	...
	internal class OracleProvider : IProvider
	{
		...
		public string ClobLike(string columnName, string nomeParametro, bool confrontoUCase)
		{
			...
			return string.Format(" dbms_lob.instr( {0},{1},1,1 ) >0 ",columnName , QueryParameterName(nomeParametro));
		}
		...
		{
			return string.Format(" LENGTH({0}) ", columnName);
		}
