...
namespace Init.SIGePro.Protocollo.DocEr.ProtocollazioneRegistrazione
{
    public class BaseProtocollazioneRegistrazione
    {
        ...
        protected long CreaUnitaDocumentale()
        {
            ...
            var unitaDocumentale = _docService.InserisciDocumentoPrimario(AuthWrapper, _datiProto.ProtoIn.Allegati.First(), _datiProto.ProtoIn.TipoDocumento, _vert.CodiceEnte, _vert.CodiceAoo, _vert.TipoDocumentoPrincipale, DatiProtoSrv, _vert.DisabilitaMetadati);
            _docService.InserisciDocumentiAllegati(AuthWrapper, unitaDocumentale.ToString(), _datiProto.ProtoIn.Allegati.Skip(1), _datiProto.ProtoIn.TipoDocumento, _vert.CodiceEnte, _vert.CodiceAoo, _vert.TipoDocumentoAllegato, DatiProtoSrv, _vert.DisabilitaMetadati);
