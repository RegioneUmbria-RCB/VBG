...
namespace Init.SIGePro.Protocollo.DocEr.Autenticazione
{
    ...
    {
        public static IAuthenticationService Create(ResolveDatiProtocollazioneService datiProtoSrv, VerticalizzazioniConfiguration vert, ProtocolloLogs logs, ProtocolloSerializer serializer, ProtocolloEnum.TipoProvenienza provenienza)
        {
            ...
            if (vert.IsLdapAuthentication && provenienza == ProtocolloEnum.TipoProvenienza.BACKOFFICE)
