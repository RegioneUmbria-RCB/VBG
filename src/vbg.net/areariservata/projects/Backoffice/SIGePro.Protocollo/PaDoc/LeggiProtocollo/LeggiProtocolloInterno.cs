...
namespace Init.SIGePro.Protocollo.PaDoc.LeggiProtocollo
{
    public class LeggiProtocolloInterno : ILeggiProtoMittentiDestinatari
    {
        ...
        public LeggiProtocolloInterno(rispostaRisultatoMittente mittente, rispostaRisultatoDestinatario[] destinatari)
        {
            _mittente = mittente;
        ...
        {
            return _destinatari.Select(x => new MittDestOut { CognomeNome = x.GetValoreDestinatario(ItemsChoiceType1.codice_ufficio) }).ToArray();
        }
