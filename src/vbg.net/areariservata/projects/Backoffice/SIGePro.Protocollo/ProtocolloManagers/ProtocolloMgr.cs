...
namespace Init.SIGePro.Protocollo.Manager
{
    public partial class ProtocolloMgr : IDisposable
    {
        ...
        private void SetProtocollo(ProtocolloEnum.TipoProvenienza provenienza, int iSource)
        {
                    ...
                    if (!String.IsNullOrEmpty(this._datiProtocollazione.Movimento.TIPOMOVIMENTO))
                    {
                        ...
                        if (tipiMovimento != null && tipiMovimento.FLAG_STC == 1)
                        {
                            ...
                            if (mappingProtocollo.OggettoMailTipo.HasValue)
                            {
                                ...
                                var wsMailTipo = new ResolveMailTipoMovimentoService(param, this._datiProtocollazione, _protocolloSerializer, _protocolloLogs);

                                _protocolloLogs.InfoFormat("LA MAIL TIPO HA VALORE? {0}", wsMailTipo != null);
                                if (wsMailTipo != null)
                                {
                                    _protoIn.Oggetto = wsMailTipo.Oggetto;
                                    _protocolloLogs.InfoFormat("OGGETTO RECUPERATO: {0}", wsMailTipo.Oggetto);
                                    _protoIn.Corpo = wsMailTipo.Corpo;
                                }
                            }
            ...
            if( _verticalizzazioneProtocolloAttivo.ValorizDataRicSpediz) { 
                if(this._datiProtocollazione.Movimento != null) {
                    _protocolloBase.ValorizzaDataRicezioneSpedizione = (this._datiProtocollazione.Movimento.CREATO_DA_STC == 1);
                } else {
                    _protocolloBase.ValorizzaDataRicezioneSpedizione = (this._datiProtocollazione.Istanza != null);
                }
            }
        }
        ...
        {
            _protocolloBase.Operatore = _verticalizzazioneProtocolloAttivo.Operatore;
            _protocolloBase.Provenienza = ProtocolloEnum.TipoProvenienza.BACKOFFICE;
        ...
        private void SetAllegati(int iSource = (int)ProtocolloEnum.Source.NONPROTOCOLLARE)
        {
            try
            {
                ...
                if (_protocolloBase.Provenienza == ProtocolloEnum.TipoProvenienza.ONLINE &&
                this._datiProtocollazione.TipoAmbito == ProtocolloEnum.AmbitoProtocollazioneEnum.DA_ISTANZA &&
                _verticalizzazioneProtocolloAttivo.InviaEmlPecArrivo == "1")
                {
                    ...
                    if (!String.IsNullOrEmpty(identificativo))
                        _protoIn.Allegati = nlaPec.GetAllegatiEml(identificativo, DateTime.Now, DateTime.Now);
                }
                ...
                if (_dati.Allegati == null && _protoIn.Allegati.Count == 0)
                {
                    ...
                    _protocolloLogs.DebugFormat("VERIFICA RECUPERO ALLEGATI: {0}", ((((iSource == (int)ProtocolloEnum.Source.INSERIMENTO_NORMALE) || (iSource == (int)ProtocolloEnum.Source.INSERIMENTO_RAPIDO) || (iSource == (int)ProtocolloEnum.Source.PROT_IST_MOV_AUT_BO) || (iSource == (int)ProtocolloEnum.Source.NONPROTOCOLLARE)) && !noAllegati) || ((iSource == (int)ProtocolloEnum.Source.ON_LINE) && !noAllegatiFO)));

                    if ((((iSource == (int)ProtocolloEnum.Source.INSERIMENTO_NORMALE) || (iSource == (int)ProtocolloEnum.Source.INSERIMENTO_RAPIDO) || (iSource == (int)ProtocolloEnum.Source.PROT_IST_MOV_AUT_BO) || (iSource == (int)ProtocolloEnum.Source.NONPROTOCOLLARE)) && !noAllegati) || ((iSource == (int)ProtocolloEnum.Source.ON_LINE) && !noAllegatiFO))
                    {
                ...
                foreach (Allegato allegato in _dati.Allegati)
                {
                    ...
                    string percorso = protoAllegatiMgr.GetPercorsoOggetto(this._datiProtocollazione.IdComune, Convert.ToInt32(allegato.Cod));
                    ...
                    var protoAllegati = new ProtocolloAllegati
                    {
                        ...
                        NOMEFILE = nomeAllegato.GetNomeCompleto(_verticalizzazioneProtocolloAttivo.NomefileOrigine, _protoIn.Allegati, _verticalizzazioneProtocolloAttivo.CreaCopiaFile == "1"),
                        Descrizione = nomeAllegato.GetDescrizioneFileCopia(allegato.Descrizione, _protoIn.Allegati, _verticalizzazioneProtocolloAttivo.CreaCopiaDescrFile == "1", 0, _verticalizzazioneProtocolloAttivo.DescrFileMaxLength),
                ...
                _protocolloLogs.Debug($"VERIFICA SE DEVE ESSERE ALLEGATO ANCHE IL FILE XML DELLA DOMANDA: PARAMETRO ALLEGA_XMLDOMANDASTC = {_verticalizzazioneProtocolloAttivo.AllegaXmlDomandaStc}, AMBITO = {this._datiProtocollazione.TipoAmbito.ToString()}");
                if (_verticalizzazioneProtocolloAttivo.AllegaXmlDomandaStc == "1" && this._datiProtocollazione.TipoAmbito == ProtocolloEnum.AmbitoProtocollazioneEnum.DA_ISTANZA)
                {
                    ...
                    if (numeroDomande > 0)
                    {
                        ...
                        else
                        {
                            ...
                            if (domanda.CodiceOggetto.HasValue)
                            {
                                ...
                                var oggetto = protoAllegatiMgr.GetById(this._datiProtocollazione.IdComune, domanda.CodiceOggetto.Value);
                ...
                if (_verticalizzazioneProtocolloAttivo.AllegatiObbligatori == "1")
                {
                    if (_protoIn.Allegati.Count == 0)
                    {
        ...
        private void SetMittenti()
        {
            try
            {
                ...
                if (_verticalizzazioneProtocolloAttivo.TipoMittDestAuto == "3")
                    tipoMittente = ProtocolloEnum.TipoMittenteEnum.AZIENDA_TECNICO;
                ...
                switch (_protoIn.Flusso)
                {
                    ...
                    case "A":
                        if (_dati.Mittenti == null)
                        {
                            ...
                            _protocolloLogs.Info($"TIPO MITTENTE: {tipoMittente.ToString()}");
        ...
        private void SetDestinatari()
        {
            try
            {
                ...
                if (_verticalizzazioneProtocolloAttivo.TipoMittDestAuto == "3")
                    tipoDestinatario = ProtocolloEnum.TipoMittenteEnum.AZIENDA_TECNICO;
            ...
            if (_datiProtocollazione.TipoAmbito == ProtocolloEnum.AmbitoProtocollazioneEnum.DA_ISTANZA)
            {
                ...
                else
                {
                    ...
                    if (!String.IsNullOrEmpty(_datiProtocollazione.Istanza.NUMEROPROTOCOLLO))
                    {
                        ...
                        _protocolloBase.IdProtocollo = _datiProtocollazione.Istanza.FKIDPROTOCOLLO;
                        _protocolloBase.NumProtocollo = sNumProtocollo;
                        _protocolloBase.AnnoProtocollo = _datiProtocollazione.Istanza.DATAPROTOCOLLO.GetValueOrDefault(DateTime.Now).Year.ToString();
            ...
            if (_datiProtocollazione.TipoAmbito == ProtocolloEnum.AmbitoProtocollazioneEnum.DA_MOVIMENTO)
            {
                ...
                else
                {
                    ...
                    if (!String.IsNullOrEmpty(_datiProtocollazione.Movimento.NUMEROPROTOCOLLO))
                    {
                        ...
                        _protocolloBase.IdProtocollo = _datiProtocollazione.Movimento.FKIDPROTOCOLLO;
                        _protocolloBase.NumProtocollo = sNumProtocollo;
                        _protocolloBase.AnnoProtocollo = _datiProtocollazione.Movimento.DATAPROTOCOLLO.GetValueOrDefault(DateTime.Now).Year.ToString();
        ...
        public void AggiungiAllegati(string numeroProtocollo, DateTime? dataProtocollo, string idProtocollo, int[] codiciAllegati)
        {
            ...
            foreach (var codice in codiciAllegati)
            {
                ...
                {
                    MimeType = mgr.GetContentType(oggetto),
                    Extension = nomeAllegato.GetEstensione(),
                    NOMEFILE = nomeAllegato.GetNomeCompleto(_verticalizzazioneProtocolloAttivo.NomefileOrigine, protoAllegatiList, _verticalizzazioneProtocolloAttivo.CreaCopiaFile == "1"),
                    Descrizione = nomeAllegato.GetDescrizioneFileCopia(oggetto.NOMEFILE, protoAllegatiList, _verticalizzazioneProtocolloAttivo.CreaCopiaDescrFile == "1", 0, _verticalizzazioneProtocolloAttivo.DescrFileMaxLength),
                    CODICEOGGETTO = oggetto.CODICEOGGETTO,
                    IDCOMUNE = oggetto.IDCOMUNE,
                    OGGETTO = oggetto.OGGETTO,
                    Percorso = percorso
            ...
            _protocolloBase.AggiungiAllegati(idProtocollo, numeroProtocollo, dataProtocollo, protoAllegatiList);
        }
        ...
        private bool PreparaLaRichiestaPerCreazioneOCambiamentoFascicolo(DatiFasc datiFasc, ProtocolloEnum.TipiFascicolazione tipoFasc = ProtocolloEnum.TipiFascicolazione.CAMBIA)
        {
            ...
            int? annoRiferimentoFascicolo = !String.IsNullOrEmpty(datiFasc.AnnoFascicolo) ? Convert.ToInt32(datiFasc.AnnoFascicolo) : DateTime.ParseExact(_fascicolo.DataFascicolo, "dd/MM/yyyy", null).Year;
        ...
        public AllOut LeggiAllegato(string IdProtocollo, string numProtocollo, string annoProtocollo, string idAllegato)
        {
            ...
            _protocolloBase.EstraiEml = _verticalizzazioneProtocolloAttivo.EstraiEml == "1";
            _protocolloBase.EstraiZip = _verticalizzazioneProtocolloAttivo.EstraiZip == "1";
            _protocolloBase.EscludiFileDaEml = _verticalizzazioneProtocolloAttivo.EscludiFilesDaEml.Split('|');
            _protocolloBase.ZipExtensions = _verticalizzazioneProtocolloAttivo.ExtFileZip.Split(',');
        ...
        public ListaTipiClassificaClassifica GetClassificaById( int IdClassifica )
        {
            try
            {
                return _protocolloBase.GetClassificaById(IdClassifica);
        ...
        public CreaUnitaDocumentaleResponse CreaUnitaDocumentale(CreaUnitaDocumentaleRequest request)
        {
            ...
            {
                var protocolloAllegato = allegato.ToProtocolloAllegati(protoAllegatiMgr, _datiProtocollazione.IdComune, _datiProtocollazione.CodiceComune, _verticalizzazioneProtocolloAttivo, protocolloAllegati);
