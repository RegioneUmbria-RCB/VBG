...
namespace Init.SIGePro.Protocollo.Folium
{
    public class VerticalizzazioniWrapper
    {
        ...
        public bool IsContenuto { get; set; }
        ...
        public string[] EstensioniAccettateFileContenuto { get; private set; }
        ...
        private VerticalizzazioneProtocolloFolium EstraiParametri(VerticalizzazioneProtocolloFolium paramVert)
        {
            try
            {
                ...
                this.EstensioniAccettateFileContenuto = null;

                if (!String.IsNullOrEmpty(paramVert.ElencoEstensioniContenuto))
                { 
                    this.EstensioniAccettateFileContenuto = paramVert.ElencoEstensioniContenuto.ToLower().Split(',');
                }
