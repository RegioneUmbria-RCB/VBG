    ...
    public class PROTOCOLLO_DOCER : ProtocolloBase
    {
        public override DatiProtocolloRes Protocollazione(DatiProtocolloIn protoIn)
        {
            ...
            try
            {
                ...
                loginSrv = AuthenticationServiceFactory.Create(this.DatiProtocollo, vert, _protocolloLogs, _protocolloSerializer, base.Provenienza);
                loginSrv.Login();
                ...
                try
                {
                    if (protoIn.Flusso == ProtocolloConstants.COD_PARTENZA && vert.TipoInvioPec == Enumeretors.TipoInvioPec.INVIO_AUTOMATICO)
                    {
                        ...
                        var datiPec = new DatiPec(protocollazione.IdUnitaDocumentale.ToString(), gestDocWrapper, _protocolloSerializer);
                        var pecAdapter = new SegnaturaPecAdapter(datiPec, vert, _protocolloSerializer);
        ...
        public override DatiProtocolloLetto LeggiProtocollo(string idProtocollo, string annoProtocollo, string numeroProtocollo)
        {
            ...
            try
            {
                ...
                var info = new LeggiDocumentoInfo(docService, idProtocollo, _protocolloLogs, _protocolloSerializer, base.EstraiEml, base.EscludiFileDaEml, base.EstraiZip, base.ZipExtensions);
        ...
        public override AllOut LeggiAllegato()
        {
            ...
            try
            {
                ...
                var docService = new GestioneDocumentaleService(vert.UrlGestioneDocumentale, loginSrv.Token, _protocolloLogs, _protocolloSerializer);
                var adapter = new DownloadDocumentoResponseAdapter(docService, IdAllegato, base.EstraiEml, base.EscludiFileDaEml, base.EstraiZip, base.ZipExtensions);
        ...
        {
            _protocolloLogs.InfoFormat("INIZIO FUNZIONALITA' CAMBIA FASCICOLO DI DOCER");
            ...
            try
            {
                ...
                _protocolloLogs.InfoFormat("FINE FUNZIONALITA' CAMBIA FASCICOLO DI DOCER");
        ...
        {
            _protocolloLogs.InfoFormat("INIZIO FUNZIONALITA' DI FASCICOLAZIONE DI DOCER");
            ...
            try
            {
                ...
                _protocolloLogs.InfoFormat("FINE FUNZIONALITA' DI FASCICOLAZIONE DI DOCER");
        ...
        public override CreaUnitaDocumentaleResponse CreaUnitaDocumentale(string tipoDocumento, IEnumerable<ProtocolloAllegati> allegati)
        {
            ...
            try
            {
                ...
                long unitaDocumentale = docService.InserisciDocumentoPrimario(loginSrv, allegati.First(), tipoDocumento, vert.CodiceEnte, vert.CodiceAoo, vert.TipoDocumentoPrincipale, DatiProtocollo, vert.DisabilitaMetadati);

                if (allegati.Count() > 1)
                    docService.InserisciDocumentiAllegati(loginSrv, unitaDocumentale.ToString(), allegati.Skip(1), tipoDocumento, vert.CodiceEnte, vert.CodiceAoo, vert.TipoDocumentoAllegato, DatiProtocollo, vert.DisabilitaMetadati);
        ...
        public override void InvioPec(string idProtocollo, string numeroProtocollo, string annoProtocollo)
        {
            ...
            try
            {
                ...
                var gestDocWrapper = new GestioneDocumentaleService(vert.UrlGestioneDocumentale, loginSrv.Token, _protocolloLogs, _protocolloSerializer);
                var datiPec = new DatiPec(idProtocollo, gestDocWrapper, _protocolloSerializer);
                var pecAdapter = new SegnaturaPecAdapter(datiPec, vert, _protocolloSerializer);
