...
namespace Init.SIGePro.Protocollo.StudioK.LeggiProtocollo
{
    ...
    {
        public LeggiProtocolloServiceWrapper(string url, string proxyAddress, string connectionString, ProtocolloLogs logs, ProtocolloSerializer serializer) : base(url, proxyAddress, connectionString, logs, serializer)
        {
