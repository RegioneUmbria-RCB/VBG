...
namespace Init.SIGePro.Protocollo.StudioK.Protocollazione
{
    ...
    {
        public ProtocollazioneServiceWrapper(string url, string proxyAddress,  string connectionString, ProtocolloLogs logs, ProtocolloSerializer serializer) : base(url, proxyAddress, connectionString, logs, serializer)
        {
