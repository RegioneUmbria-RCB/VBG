...
namespace Init.SIGePro.Protocollo.ProtocolloServices
{
    public class ResolveDatiProtocollazioneService
    {
        ...
        public ResolveDatiProtocollazioneService(string idComune, string idComuneAlias, string software, DataBase db, Istanze istanza, Movimenti movimento, int? codiceOperatore, ProtocolloEnum.AmbitoProtocollazioneEnum ambito, string token, string codiceComune = "", PecInbox datiPec = null)
        {
            IdComune = idComune;
