...
{
    /// <summary>
    /// La classe è stata chiamata HalleySegnaturaDocumentiBuilder perchè è la parte riguardante i documenti della segnatura da inviare al web service, in realtà però 
    ...
    /// </summary>
    public class HalleySegnaturaDocumentiBuilder
    {
        ...
        public HalleySegnaturaDocumentiBuilder(List<ProtocolloAllegati> listAllegati, string tipoDocPrincipale, string tipoDocAllegato)
        {
