...
namespace Init.SIGePro.Protocollo.EGrammata2.Protocollazione
{
    public class ProtocollazioneRequestInterno : IRequestProtocollo
    {
        ...
        public CopieArrIn[] GetCopieArrIn()
        {
            ...
            if (_configuration.Titolario != null)
            {
                copie.Classifica = new Classifica { Classificazione = _configuration.Titolario };
            }

            if (_configuration.Vert.Fascicolo != null)
            {
                copie.NumFasc = _configuration.Vert.Fascicolo[1];
                copie.AnnoFasc = _configuration.Vert.Fascicolo[0];
                copie.NumSottofasc = _configuration.Vert.Fascicolo[2];
            }
