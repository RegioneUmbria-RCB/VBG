        ...
        public Insert.corrispondenti.corrispondenteRow InsertCorrispondente(IAnagraficaAmministrazione anag, string userName)
        {
            try
            {
                using (var ws = CreaWebService())
                {
                    ...
                    var response = ws.InsertCorrispondente(Auth, anag.CodiceFiscalePartitaIva, anag.NomeCognome, anag.Indirizzo, anag.Cap, codiceComune, anag.Pec, anag.Telefono, anag.Fax, userName);
