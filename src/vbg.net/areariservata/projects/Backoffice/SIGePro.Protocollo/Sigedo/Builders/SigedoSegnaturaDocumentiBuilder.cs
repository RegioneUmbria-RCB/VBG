...
{
    /// <summary>
    /// La classe è stata chiamata SigedoSegnaturaDocumentiBuilder perchè è la parte riguardante i documenti della segnatura da inviare al web service, in realtà però 
    ...
    /// </summary>
    public class SigedoSegnaturaDocumentiBuilder
    {
        ...
        public SigedoSegnaturaDocumentiBuilder(List<ProtocolloAllegati> listAllegati, string tipoDocPrincipale, string tipoDocAllegato)
        {
