    ...
    public class SIT_MODENA : SitBase
	{
        ...
        protected override RetSit VerificaSub()
        {
            try
            {
                ...
                {
                    this.DataSit.Sub = "";
                    return RestituisciErroreSit(GetErroreDiValidazione(NomiCampi.Subalterno), MessageCode.SubValidazione, false);
                }
            ...
            {
                return RestituisciErroreSit(ex.Message, MessageCode.SubValidazione, false);
            }
        }
