					...
					namespace Init.SIGePro.Data
					{
						...
						///
						[DataTable("CAMPIGRADUATORIA")]
						[Serializable]
						public partial class CampiGraduatoria : BaseDataClass
						{
							#region Membri privati

                            private int? m_id = null;

                            private int? m_fk_gd_id = null;
							...
							[isRequired]
                            [DataField("FK_GD_ID" , Type=DbType.Decimal)]
							public int? FkGdId
							{
								get{ return m_fk_gd_id; }
								set{ m_fk_gd_id = value; }
							}
