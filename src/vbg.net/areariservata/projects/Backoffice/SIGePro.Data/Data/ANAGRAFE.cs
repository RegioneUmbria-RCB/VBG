...
namespace Init.SIGePro.Data
{
	...
	public class Anagrafe : BaseDataClass, IClasseContestoModelloDinamico
	{
        ...
        #region inps e inail
        [DataField("INAIL_MATRICOLA", Size = 16, Type = DbType.String)]
        [XmlElement(Order = 65)]
        public string InpsMatricola { get; set; }

        [DataField("INAIL_CODICESEDE", Size = 6, Type = DbType.String)]
        [XmlElement(Order = 66)]
        public string InpsCodiceSede { get; set; }

        [DataField("INPS_MATRICOLA", Size = 16, Type = DbType.String)]
        [XmlElement(Order = 67)]
        ...
        [XmlIgnore]
        [DataField("CASSAEDILE_CODICESEDE", Size = 50, Type = DbType.String)]
        [XmlElement(Order = 72)]
        ...
        [XmlIgnore]
        [DataField("OPER_IDENTIFICAZIONE", Size = 10, Type = DbType.String)]
        [XmlElement(Order = 74)]
        public string OperIdentificazione { get; set; }
