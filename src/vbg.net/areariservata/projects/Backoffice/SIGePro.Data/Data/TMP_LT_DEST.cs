...
{
	[DataTable("TMP_LT_DEST")]
	public class Tmp_Lt_Dest : BaseDataClass
	{
		string sesis=null;
		...
		string rowtext=null;
		[DataField("ROWTEXT",Size=4000, Type=DbType.String, Compare="like", CaseSensitive=false)]
		...
		string pretext=null;
		[DataField("PRETEXT",Size=50, Type=DbType.String, Compare="like", CaseSensitive=false)]
