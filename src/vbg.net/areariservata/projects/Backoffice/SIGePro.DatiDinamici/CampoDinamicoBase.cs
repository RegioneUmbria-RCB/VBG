...
namespace Init.SIGePro.DatiDinamici
{
	public class CampoDinamicoBase
	{
        ...
        public bool CampoNascosto { get { return this.TipoCampo == TipoControlloEnum.CampoNascosto; } }

        public int? IdRiferimentoNote { get; set; }
		...
		public bool RichiedeEtichetta
		{
			get { return this.TipoCampo != TipoControlloEnum.Titolo && 
                         this.TipoCampo != TipoControlloEnum.Label &&
                         this.TipoCampo != TipoControlloEnum.TestoInSolaLettura; }
		}
