...
namespace Init.SIGePro.Manager
{
	...
	public class IstanzeMgr : BaseManager, IIstanzeManager
    {
        ...
        public int GetCodiceIstanzaDaUuid(string idComune, string uuid)
        {
            var sql = "select codiceistanza from istanze where idcomune = {0} and uuid = {1}";
            ...
            dr => dr.GetInt32(0)).FirstOrDefault();
        }
