...
using log4net;
	...
	public class EventiSchedeDinamicheAttivitaService
	{
		...
		public EventiSchedeDinamicheAttivitaService(ICurrentRequestContext ctxt)
		{
            ...
            this._authInfo = AuthenticationManager.Login(alias, Settings.Default.SigeproSecurityUsername, Settings.Default.SigeproSecurityPassword, ContextType.ExternalUsers);
