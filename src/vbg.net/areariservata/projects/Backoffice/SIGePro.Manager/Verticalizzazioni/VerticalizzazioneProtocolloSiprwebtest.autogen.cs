			...
			namespace Init.SIGePro.Verticalizzazioni
			{
				/**************************************************************************************************************************************
				*
				* Classe generata automaticamente dalla verticalizzazione PROTOCOLLO_SIPRWEBTEST il 26/08/2014 17.28.00
				...
				***************************************************************************************************************************************/
				...
				/// <summary>
				/// Questa verticalizzazione è stata creata per rendere più semplici le operazioni in ambiente di test del protocollo siprweb, l'ambiente di test e produzione di questo tipo di protocollo infatti hanno due wsdl differenti, pertanto necessitano di due componenti differenti. Per chiamare questa verticalizzazione è necessario impostare a PROTOCOLLO_SIPRWEBTEST il parametro TIPO_PROTOCOLLO della verticalizzazione PROTOCOLLO_ATTIVO.
				/// </summary>
				public partial class VerticalizzazioneProtocolloSiprwebtest : Verticalizzazione
				{
					private const string NOME_VERTICALIZZAZIONE = "PROTOCOLLO_SIPRWEBTEST";

                    public VerticalizzazioneProtocolloSiprwebtest()
                    {

                    }

					public VerticalizzazioneProtocolloSiprwebtest(string idComuneAlias, string software, string codiceComune) : base(idComuneAlias, NOME_VERTICALIZZAZIONE , software, codiceComune){}
