...
namespace Init.SIGePro.Manager.Verticalizzazioni
{
    public partial class VerticalizzazioneProtocolloPal : Verticalizzazione
    {
        ...
        /// <summary>
        /// Indicare il valore 1 se l'utilizzo degli assegnatari risulta essere obbligatorio (confrontarsi con PAL per questo), il parametro è stato inserito per garantire una retro compatibilità con le versioni precedenti che non prevedevano l''assegnazione.
        /// </summary>
        public string GestisciAssegnatari
        {
            get { return GetString("GESTISCI_ASSEGNATARI"); }
            set { SetString("GESTISCI_ASSEGNATARI", value); }
        }
    }
}
