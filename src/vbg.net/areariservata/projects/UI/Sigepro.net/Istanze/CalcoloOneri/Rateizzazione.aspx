...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<asp:View runat="server" ID="dettaglioView">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    ...
                    <fieldset>
                        ...
                        <init:LabeledDropDownList ID="ddlFrequenzaRateAmmortamentoFrancese" runat="server" Enabled="false" Descrizione="*Frequenza rate" Item-DataValueField="Key" Item-DataTextField="Value" Item-AutoPostBack="false" />
                        ...
                        <init:LabeledTextBox ID="txSpeseRateizzazioni" runat="server" Descrizione="Spese Rateizzazioni"  HelpControl="divSpeseRateizzazioni" Item-ReadOnly=true/>
    ...
    <init:HelpDiv ID="divSpeseRateizzazioni" runat="server">
