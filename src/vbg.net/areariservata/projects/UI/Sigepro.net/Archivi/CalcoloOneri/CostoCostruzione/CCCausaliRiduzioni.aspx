<%@ Page Language="C#" MasterPageFile="~/SigeproNetMaster.master" AutoEventWireup="true" CodeBehind="CCCausaliRiduzioni.aspx.cs" Inherits="Sigepro.net.Archivi.CalcoloOneri.CostoCostruzione.CCCausaliRiduzioni" Title="Costo di costruzione - Causali di riduzione/incremento" %>
	...
	<asp:MultiView runat="server" ID="multiView" ActiveViewIndex="0" OnActiveViewChanged="multiView_ActiveViewChanged">
			...
			<fieldset>
				<div>
					<init:GridViewEx  runat="server" ID="gvLista" AutoGenerateColumns="False" OnSelectedIndexChanged="gvLista_SelectedIndexChanged" DatabindOnFirstLoad="False"
						DataSourceID="CCCausaliRiduzioniDataSource" DefaultSortDirection="Ascending" DefaultSortExpression="Id" DataKeyNames="Id">
					...
					<asp:ObjectDataSource ID="CCCausaliRiduzioniDataSource" SelectMethod="Find" TypeName="Init.SIGePro.Manager.CCCausaliRiduzioniTMgr" SortParameterName="sortExpression"
						runat="server">
						<SelectParameters>
		...
		<asp:View runat="server" ID="dettaglioView">
			<fieldset>
				...
				<init:HelpDiv ID="hdDescrizione" runat="server">Ad una tipologia vengono associate delle causali di riduzione/incremento che potranno essere utilizzate nei calcoli del costo di costruzione</init:HelpDiv>
				<div class="Bottoni">
