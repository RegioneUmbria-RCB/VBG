	...
	public partial class AreaRiservataServiceBase
	{
        ...
        public EndoprocedimentoMappatoDto GetEndoprocedimentoDaIdMappatura(string token, string codiceEndoRemoto)
        {
            ...
            using (var db = authInfo.CreateDatabase())
            {
                ...
                var schede = mgr.GetSchedeDinamicheDaEndoprocedimentiList(idComune, new List<int> { endo.Codiceinventario.Value}, Enumerable.Empty<string>(), true);
                ...
                return new EndoprocedimentoMappatoDto
                {
                    ...
                    Schede = schede.Cast<SchedaDinamicaDto>().ToList(),
