    ...
    AlberoInterventi.prototype = {
        ...
        initialize: function (settings) {
            ...
            if (this.settings.divRicerca && this.settings.lnkRicerca) {
                ...
                var useBootstrap = this.settings.useBootstrap;
                var corpoRicerca = useBootstrap ? this.settings.divRicerca.find('.modal-body') : this.settings.divRicerca;
            ...
            var idDaCookie = sessionStorage.getItem(self.cookieName);
        ...
        creaNodoAlbero: function (dati) {
            ...
            var divTestuale = $('<span />', { 'class': 'descrizioneAteco' }).text(testoNodo);

            var img = $('<i />', {
                'class': dati.HaNodiFiglio ? 'glyphicon glyphicon-folder-close' : 'glyphicon glyphicon-list-alt'
            });

            var imagePlaceholder = dati.HaNote ? $("<a href=\'#\'><i class='glyphicon glyphicon-question-sign'></i></a>") : $("<i class='glyphicon glyphicon-none'></i>");
        ...
        createSubtree: function (el, msg) {
            ...
            for (var i = 0; i < msg.d.length; i++) {
                li = this.creaNodoAlbero(msg.d[i]);
                li.appendTo(el);
            }
