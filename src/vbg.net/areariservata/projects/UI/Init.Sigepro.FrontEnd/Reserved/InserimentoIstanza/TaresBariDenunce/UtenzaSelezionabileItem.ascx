<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UtenzaSelezionabileItem.ascx.cs" Inherits="Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza.TaresBariDenunce.UtenzaSelezionabileItem" %>
