...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza
{
	public partial class RiepilogoDomandaHtml : IstanzeStepPage
	{
		...
		{
            var riepilogo = ReadFacade.Domanda.Documenti.Intervento.GetRiepilogoDomanda();

            if ( riepilogo == null)
            {
                this.Errori.Add($"L'intervento selezionato \"[{ReadFacade.Domanda.AltriDati.Intervento.Codice}] - {ReadFacade.Domanda.AltriDati.Intervento.Descrizione}\" non è configurato con un riepilogo domanda");
                this.Master.MostraBottoneAvanti = false;
                this.Master.MostraBottoneInviaDomanda = false;
                return true;
            }

			return riepilogo.RichiedeFirmaDigitale;
		}
