        ...
        <asp:MultiView runat="server" ID="multiView" ActiveViewIndex="0">
            ...
            <asp:View runat="server" ID="dettaglioView">
                    ...
                    $(function () {
                        ...
                        campi = {
                            indirizzo: $("#<%= acIndirizzo.ClientID %>"),
                                ...
                                accessoTipo: $("#<%=txtAccessoTipo.Inner.ClientID%>"),
                                accessoNumero: $("#<%=txtAccessoNumero.Inner.ClientID%>"),
                                accessoDescrizione: $("#<%=txtAccessoDescrizione.Inner.ClientID%>")
                            },
                            campiIdx = [];
                        ...
                        campi.codViario.parent().find('input[type=\'text\']').on('keydown', function () {
                            ...
                            campi.accessoTipo.val('');
                            campi.accessoNumero.val('');
                            campi.accessoDescrizione.val('');
                        });
                        ...
                        campi.civico.on('keydown', function () {
                            ...
                            campi.accessoTipo.val('').data('validated', 0);
                            campi.accessoNumero.val('').data('validated', 0);
                            campi.accessoDescrizione.val('').data('validated', 0);
                        });
                        ...
                        campi.accessoTipo.on('keydown', function () {
                            campi.accessoTipo.val('').data('validated', 0);
                            campi.accessoNumero.val('').data('validated', 0);
                            campi.accessoDescrizione.val('').data('validated', 0);
                        });
                        ...
                        function validate(el) {
                            ...
                            onSuccess = function (d) {
                                ...
                                campi.accessoTipo.val(data.accessoTipo);
                                campi.accessoNumero.val(data.accessoNumero);
                                campi.accessoDescrizione.val(data.accessoDescrizione);
                        ...
                        function valoriCampi(el) {
                            return JSON.stringify({
                                ...
                                accessoTipo: campi.accessoTipo.val() || ''
                            });
                        }
                ...
                <div class="form-small">
                    ...
                    <div class="row">
                        <ar:TextBox runat="server" ID="txtAccessoTipo" Label="Tipo Accesso" MaxLength="10" Columns="7" CssClass="ricerca-sit" InnerAttributes="data-campo-sit=AccessoTipo" data-campo-sit="AccessoTipo" BtSize="Col3" />
                        <ar:TextBox runat="server" ID="txtAccessoNumero" Label="Numero Accesso" MaxLength="10" Columns="10" CssClass="ricerca-sit" InnerAttributes="data-campo-sit=AccessoNumero" data-campo-sit="AccessoNumero" BtSize="Col3" />
                        <ar:TextBox runat="server" ID="txtAccessoDescrizione" Label="Descrizione Accesso" MaxLength="200" Columns="20" CssClass="ricerca-sit" InnerAttributes="data-campo-sit=AccessoDescrizione" data-campo-sit="AccessoDescrizione" BtSize="Col6" />
                    </div>
