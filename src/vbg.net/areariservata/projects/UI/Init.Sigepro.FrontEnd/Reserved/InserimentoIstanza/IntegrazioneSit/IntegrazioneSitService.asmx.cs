...
namespace Init.Sigepro.FrontEnd.Reserved.InserimentoIstanza.IntegrazioneSit
{
	...
	public class IntegrazioneSitService : System.Web.Services.WebService
	{
		...
		[WebMethod]
		[ScriptMethod]
		public object ValidaCampo(string nomeCampo, string codiceStradario, string civico, string esponente, string tipoCatasto, string sezione, string foglio, string particella, string sub, string accessoTipo)
		{
			...
			return new {
				...
				ui =r.Ui,
				zona = r.Zona,
                accessoTipo = r.AccessoTipo,
                accessoNumero = r.AccessoNumero,
                accessoDescrizione = r.AccessoDescrizione
			};
		}
