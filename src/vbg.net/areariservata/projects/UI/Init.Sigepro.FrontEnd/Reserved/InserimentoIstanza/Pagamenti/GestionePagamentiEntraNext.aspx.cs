...
{
    public partial class GestionePagamentiEntraNext : IstanzeStepPage
    {
        ...
        [Inject]
        public PagamentiEntraNextService PagamentiEntraNextService { get; set; }
        [Inject]
        ...
        {
            //if (PagamentiEntraNextService.GetPagamentiInSospeso(IdDomanda).Count() > 0)
            //{
