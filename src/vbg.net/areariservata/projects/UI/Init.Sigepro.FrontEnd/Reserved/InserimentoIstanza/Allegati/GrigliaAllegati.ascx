...
<asp:GridView runat="server" ID="gvAllegati"
    ...
    OnRowCancelingEdit="RowCancelingEdit1"
    GridLines="None"
        ...
        <asp:TemplateField HeaderText="Descrizione">
            <ItemTemplate>
                <div style="text-align: justify">
                    <asp:Literal runat="server" ID="ltrDescrizioneallegato" Text='<%# Eval("Descrizione", "{0}<br />") %>' />
                    <small>
                        <asp:Literal runat="server" Text='<%# Eval("DimensioneMassimaStr", "<b>Max {0}</b><br />") %>' />
                        <asp:Literal runat="server" Text='<%# Eval("EstensioniAmmesse", "<b>Estensioni ammesse:</b> {0}") %>' />
                    </small>
                </div>
            </ItemTemplate>
        </asp:TemplateField>
