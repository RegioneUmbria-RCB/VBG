...
{
	public partial class AllegatiBandoA1 : IstanzeStepPage
	{
		...
		{
			var datiBando = this._service.GetDatiDomandaA1(IdDomanda, CodiceOggettoAllegato1, CodiceOggettoAllegato2, CodiceOggettoAllegato7, CodiceOggettoAllegatoAltreSedi);
