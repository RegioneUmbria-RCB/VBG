<%@ Page Title="" Language="C#" MasterPageFile="~/AreaRiservataMaster.Master" AutoEventWireup="true" CodeBehind="vbg-nuova-domanda.aspx.cs" Inherits="Init.Sigepro.FrontEnd.Reserved.vbg_nuova_domanda" %>
    ...
    <div class="trasferimento">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                Fai click su <a href="<%=RedirUrl %>" id="redir">questo link</a> se non vuoi attendere
            </div>
        </div>
