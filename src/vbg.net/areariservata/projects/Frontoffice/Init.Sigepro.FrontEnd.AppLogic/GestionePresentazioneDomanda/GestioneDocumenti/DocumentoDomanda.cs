	...
	public class DocumentoDomanda
	{
		...
		public class AllegatoUtente : AllegatoDellaDomanda
		{
			...
			public DocumentiType ToDocumentiType()
			{
				...
				{
					id = this._parent.IdRiferimentoBackoffice.ToString(),
        ...
        public int DimensioneMassima { get; private set; }
        public string EstensioniAmmesse { get; private set; }
        ...
        public static DocumentoDomanda FromOggettiRow(PresentazioneIstanzaDbV2.OGGETTIRow oggettiRow, PresentazioneIstanzaDbV2.AllegatiRow allegatiRow)
		{
			var d = new DocumentoDomanda()
			{
                ...
                DimensioneMassima = oggettiRow.IsDimensioneMassimaNull() ? 0 : oggettiRow.DimensioneMassima,
                EstensioniAmmesse = oggettiRow.EstensioniAmmesse
			};
