...
namespace Init.Sigepro.FrontEnd.AppLogic.GestionePresentazioneDomanda.GestioneDocumenti
{
	...
	public class AllegatiDomandaBuilder
	{
        ...
        internal AllegatiDomandaBuilder WithEstensioniAmmesse(string estensioniAmmesse)
        {
            this._dataRow.EstensioniAmmesse = estensioniAmmesse;

            return this;
        }

        internal AllegatiDomandaBuilder WithDimensioneMassima(int dimensioneMassima)
        {
            this._dataRow.DimensioneMassima = dimensioneMassima;
