...
{
    public class ListaDocumentiIntervento : IGetByRiferimentoBackoffice
	{
        ...
        public DocumentoDomanda GetByRiferimentoBackoffice(int riferimentoBackoffice)
        {
            return this._documenti.Where(x => x.IdRiferimentoBackoffice.HasValue && x.IdRiferimentoBackoffice.Value == riferimentoBackoffice).FirstOrDefault();
        }
