...
namespace Init.Sigepro.FrontEnd.AppLogic.DatiDinamici
{
	...
	public interface IDatiDinamiciRepository
	{
		...
		WsListaModelliDinamiciDomanda GetSchedeDaInterventoEEndo(int intervento, IEnumerable<int> endo, IEnumerable<string> tipiLocalizzazioni, UsaTipiLocalizzazioniPerSelezionareSchedeDinamiche usaTipiLocalizzazioni);
	...
	internal class WsDatiDinamiciRepository : WsAreaRiservataRepositoryBase, IDatiDinamiciRepository
	{
		...
		public WsListaModelliDinamiciDomanda GetSchedeDaInterventoEEndo(int intervento, IEnumerable<int> endo, IEnumerable<string> tipiLocalizzazioni, UsaTipiLocalizzazioniPerSelezionareSchedeDinamiche usaTipiLocalizzazioni)
		{
