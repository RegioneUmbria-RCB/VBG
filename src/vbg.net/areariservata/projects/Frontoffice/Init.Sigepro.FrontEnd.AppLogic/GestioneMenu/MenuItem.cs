...
namespace Init.Sigepro.FrontEnd.AppLogic.GestioneMenu
{
    ...
    public class MenuItem
    {
        ...
        public string Url
        {
            ...
            set
            {
                this._url = new MenuUrlParser(this.CompletaUrl, this.PermettiToken).Completa(value);
            }
        }
        ...
        [XmlAttribute(AttributeName = "permetti-token")]
        public bool PermettiToken { get; set; }
