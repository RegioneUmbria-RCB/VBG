...
namespace Init.Sigepro.FrontEnd.AppLogic.Configurazione.V2.Builders
{
	internal class ParametriSigeproSecurityBuilder : AreaRiservataWebConfigBuilder,IConfigurazioneBuilder<ParametriSigeproSecurity>
	{
		...
		public ParametriSigeproSecurityBuilder(IAliasSoftwareResolver aliasSoftwareResolver)
		{
		...
		public ParametriSigeproSecurity Build()
		{
            ...
            var urlServizioEntiTerzi    = sigeproAspNetBaseUrl + Constants.WS_SCRIVANIA_ENTI_TERZI;
            var urlBookmarks            = sigeproAspNetBaseUrl + Constants.WS_BOOKMARKS;
            var urlServizioAccessoAttiSiena = sigeproAspNetBaseUrl + Constants.WS_ACCESSO_ATTI;
            ...
            var urlServizioAutorizzazioniTransiti = sigeproJavaBaseUrl + Constants.WS_AUTORIZZAZIONI_TRANSITI;
			...
			return new ParametriSigeproSecurity(/*url, username, password,*/
                                                ...
                                                urlBookmarks, urlWsModulistica, urlGenerazioneQrCode, urlServizioEntiTerzi, urlServizioAccessoAttiSiena, urlServizioAutorizzazioniTransiti);
