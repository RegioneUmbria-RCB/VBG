...
namespace Init.Sigepro.FrontEnd.AppLogic.Configurazione.V2
{
    public class ParametriSigeproSecurity : IParametriConfigurazione
    {
        ...
        internal ParametriSigeproSecurity(/*string serviceUrl, string username, string md5password, */string urlAreaRiservata, string urlIstanze, string urlAlboPretorio,
                                        ...
                                        string urlServizioEntiTerzi, string urlServizioAccessoAttiSiena, string urlServizioAutorizzazioniTransiti)
        {
            ...
            if (String.IsNullOrEmpty(urlConversioneFiles))
                throw new ArgumentNullException("urlConversioneFiles");

            if (String.IsNullOrEmpty(urlVerificaFirma))
                throw new ArgumentNullException("urlVerificaFirma");
            ...
            this.UrlServizioEntiTerzi = urlServizioEntiTerzi;
            this.UrlServizioAccessoAttiSiena = urlServizioAccessoAttiSiena;
            this.UrlServizioAutorizzazioniTransiti = urlServizioAutorizzazioniTransiti;
        }
