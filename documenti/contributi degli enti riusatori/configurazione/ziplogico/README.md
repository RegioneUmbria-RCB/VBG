...
1. Viene automaticamente selezionato il documento principale dello zip logico e vengono contrassegnati come non selezionabili i documenti che appartengono allo zip logico.
 ![Protocollazione](./immagini/zip_logico_protocollazione_2.png)
...
![Download](./immagini/zip-logico-readonly.png)
...
![Documento con link](./immagini/zip_logico_documento_link.png)
...
![Documenti](./immagini/zip_logico_documento_link_0.png)
...
![Notifica STC](./immagini/zip-logico-notifica-stc.png)
