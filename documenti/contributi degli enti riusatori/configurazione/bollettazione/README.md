...
Nella sezione operativa vengono prodotti i risultati dell'elaborazione dei due algoritmi principali e vi è data la possibilità di inviare al sottosistema di pagamento implementato le righe ottenute.
...
- Periodi di bollettazione
    ...
    viene impostata la cadenza di bollettazione e decide le date inizio / fine di recupero della bollettazione
  - Mensile
  - Bimestrale
  - Trimestrale
  - ...
...
- Scadenza periodo
    ...
    superiori a 500€, quelli inferiori avranno la data di scadenza presa dalla bollettazione ed eventualmente impostata da questo parametro )
...
- Titolarità della concessione
    ...
    VALIDO Solo per **Mercati**. Indica l'anagrafica destinataria della bollettazione. È possibile specificare i seguenti valori:
...
E' possibile indicare un range di rateizzazione che sarà applicato automaticamente, in fase di invio al nodo dei pagamenti, sugli importi ( ad esempio tutti gli importi sopra i 500€ saranno soggetti a rateizzazione ).
...
![calcolo tabella](./immagini/calcolo_cu_tabella1.png )
...
![Calcolo tabella 2](./immagini/calcolo_cu_tabella2.png )
...
![configurazione mercati 1](./immagini/configurazione_mercati_boll_0_1.png )
...
![configurazione mercati 3](./immagini/configurazione_mercati_boll_3.png )
...
![configruazione posteggi](./immagini/configurazione_posteggi_1.png )
...
![gestione bollettazione lista](./immagini/gestione_bollettazione_lista.png )
...
![gestione bollettazione nuvoa](./immagini/gestione_bollettazione_nuova.png )

Nella maschera deve essere selezionato il tipo di bollettazione.

![gestione bollettazione nuova tipo](./immagini/gestione_bollettazione_nuova_tipo_boll.png )
...
![gestione bollettazione nuova periodo](./immagini/gestione_bollettazione_nuova_periodo.png )
...
![gestione bollettazione istanza](./immagini/gestione_bollettazione_istanza_1.png )
...
![gestione bollettazione 1](./immagini/gestione_bollettazione_1.png )
...
![gestione bollettazione aggiungi riga](./immagini/gestione_bollettazione_aggiungi_riga.png )
...
![gestione bollettazione dettaglio](./immagini/gestione_bollettazione_dettaglio.png )
...
![gestione bollettazione rettifica](./immagini/gestione_bollettazione_rettifica.png )
...
![gestione bollettazione rettifica 2](./immagini/gestione_bollettazione_rettifica_2.png )
...
![gestione bollettazione rettifica 3](./immagini/gestione_bollettazione_rettifica_3.png )
...
![gestione bollettazione invio nodo pagamenti](./immagini/gestione_bollettazione_invia_sistemi_pagamenti.png )
...
![gestione bollettazione posizioni debitorie](./immagini/gestione_bollettazione_stati_invia_pos_debitoria.png )

che mostrerà i seguenti stati:

- **Conclusa Positivamente**
    Quando la posizione debitoria viene pagata nel sistema dei pagamenti comparià un'icona verde ![gestione bollettazione posizione debitoria chiusa positivamente](./immagini/gestione_bollettazione_stato_conclusa_positivamente.png )
- **Conclusa Negativamente**
    Se il pagamento di una posizione debitoria è stata annullato o comunque non è andata a buon fine nel sistema dei pagamenti, viene mostrata una icona rossa ![gestione bollettazione posizione debitoria chiusa negativamente](./immagini/gestione_bollettazione_stato_conclusa_negativamente.png )
- **In Corso**
    Se la posizione debitoria è in attesa di pagamento o annullamento da parte del soggetto a cui è stata addebitata, viene mostrata un'icona gialla ![gestione bollettazione posizione debitoria in corso](./immagini/gestione_bollettazione_stato_in_corso.png )
...
La funzionalità è raggiungibile dal seguente link ![comunicazioni massive 1](./immagini/comunicazioni/massive_001.png )
